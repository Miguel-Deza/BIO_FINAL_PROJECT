var GridBuilder = (function () {
    ...
    function constructGrid() {
        ...
        $('#grid th').hover(function() {
            ...
            var text = self.hasClass("included") ? "Parte final de la cadena" : "No es la parte final";
            ...
            for (var i = 0; i < width; i++) {
                for (var j = 0; j < height; j++) {
                    ...
                    mCellMap[i + "_" + j] = {
                        ...
                        'diagonalScoreText': mPathTable[i - 1][j - 1] + " + " + comparisonScore + " (Debido a " + (isMatch ? "match" : "mismatch") + " entre " + mTopSequence[i - 1] + " & " + mSideSequence[j - 1] + ") = " + moveDgScore,
